...
<head>
  ...
  <title>Karla Bispo | Blog Raízes da Infância</title>
  ...
  <main id="main">
    ...
    <header id="header" class="d-flex flex-column justify-content-center">
        ...
        <ul>
            ...
            <li><a href="{{route('welcome')}}#services" class="nav-link scrollto"><i class="bx bx-server"></i> <span>Serviços</span></a></li>
            ...
            <div class="sidebar">
              ...
              <div class="sidebar-item categories">
                <ul>
                  ...
                  <li><a href="#">Disforia de Gênero <span>(12)</span></a></li>
                  <li><a href="#">Primeira Infância <span>(5)</span></a></li>
                  <li><a href="#">Adolescência <span>(22)</span></a></li>
                  <li><a href="#">Temperamentos <span>(8)</span></a></li>
